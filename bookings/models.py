...
class Booking(models.Model):
    ...
    total_price = models.DecimalField(max_digits=10, decimal_places=2, default=0.00)  # Room price only
    service_charge = models.DecimalField(max_digits=10, decimal_places=2, default=0.00)
    total_amount = models.DecimalField(max_digits=10, decimal_places=2, default=0.00)  # Room price + service charge
    ...
    def save(self, *args, **kwargs):
        if self.check_in and self.check_out:
            ...
            self.service_charge = self.total_price * Decimal('0.05')
